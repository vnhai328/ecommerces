                ...
                @if(addon_is_activated('wholesale'))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('wholesale-products.all')}}" class="aiz-side-nav-link {{ areActiveRoutes(['wholesale-products.edit']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('All Wholesale Products') }}</span>
                                </a>
                            </li>
{{--                            <li class="aiz-side-nav-item">--}}
{{--                                <a href="{{route('wholesale_products.in_house')}}" class="aiz-side-nav-link {{ areActiveRoutes(['wholesale-products.edit']) }}">--}}
{{--                                    <span class="aiz-side-nav-text">{{ translate('In House Wholesale Products') }}</span>--}}
{{--                                </a>--}}
{{--                            </li>--}}
{{--                            <li class="aiz-side-nav-item">--}}
{{--                                <a href="{{route('wholesale_products.seller')}}" class="aiz-side-nav-link {{ areActiveRoutes(['wholesale-products.edit']) }}">--}}
